...
### (6421358073665931765) Transaction Buffer Create

| Label | Value | Type |
|-------|-------|------|
| Multisig | `multisig` | `account` |
| Create transaction buffer | `transaction_buffer` | `account` |
| Buffer index | `buffer_index` | `u8` |
| Vault index | `vault_index` | `u8` |
| Final buffer hash | `final_buffer_hash` | `bytes32` |
| Final buffer size | `final_buffer_size` | `u16` |
| Buffer | `buffer` | `borsh_bytes` |
| Creator | `creator` | `account` |
| Rent payer | `rent_payer` | `account` |
| _(not shown)_ | `system_program` | `account` |

### (10589631805017791974) Transaction Buffer Extend

| Label | Value | Type |
|-------|-------|------|
| Multisig | `multisig` | `account` |
| Extend transaction buffer | `transaction_buffer` | `account` |
| Buffer | `buffer` | `borsh_bytes` |
| Creator | `creator` | `account` |

### (7400004113956648465) Transaction Buffer Close

| Label | Value | Type |
|-------|-------|------|
| Multisig | `multisig` | `account` |
| Close transaction buffer | `transaction_buffer` | `account` |
| Creator | `creator` | `account` |

### (16659085876316681950) Vault Transaction Create From Buffer

| Label | Value | Type |
|-------|-------|------|
| Multisig | `multisig` | `account` |
| Create vault transaction | `transaction` | `account` |
| From transaction buffer | `transaction_buffer` | `account` |
| Vault index | `vault_index` | `u8` |
| Ephemeral signers | `ephemeral_signers` | `u8` |
| Memo | `memo` | `borsh_string` |
| Creator | `creator` | `account` |
| Rent payer | `rent_payer` | `account` |
| _(not shown)_ | `transaction_message` | `borsh_bytes` |
| _(not shown)_ | `system_program` | `account` |
| _(not shown)_ | `buffer_creator` | `account` |

### (13455472106436610896) Config Transaction Accounts Close

| Label | Value | Type |
|-------|-------|------|
| Multisig | `multisig` | `account` |
| Close config transaction | `transaction` | `account` |
| Proposal | `proposal` | `account` |
| Rent collector | `rent_collector` | `account` |
| _(not shown)_ | `system_program` | `account` |

### (11937392256760891332) Vault Transaction Accounts Close

| Label | Value | Type |
|-------|-------|------|
| Multisig | `multisig` | `account` |
| Close vault transaction | `transaction` | `account` |
| Proposal | `proposal` | `account` |
| Rent collector | `rent_collector` | `account` |
| _(not shown)_ | `system_program` | `account` |

### (17825604122730238598) Vault Batch Transaction Account Close

| Label | Value | Type |
|-------|-------|------|
| Multisig | `multisig` | `account` |
| Close batch transaction | `transaction` | `account` |
| Batch | `batch` | `account` |
| Proposal | `proposal` | `account` |
| Rent collector | `rent_collector` | `account` |
| _(not shown)_ | `system_program` | `account` |

### (18377895415883744474) Batch Accounts Close

| Label | Value | Type |
|-------|-------|------|
| Multisig | `multisig` | `account` |
| Close batch | `batch` | `account` |
| Proposal | `proposal` | `account` |
| Rent collector | `rent_collector` | `account` |
| _(not shown)_ | `system_program` | `account` |

### (15597510107662302392) Program Config Init

| Label | Value | Type |
|-------|-------|------|
| Initialize program config | `program_config` | `account` |
| Authority | `authority` | `pubkey` |
| Multisig creation fee | `multisig_creation_fee` | `lamports` |
| Treasury | `treasury` | `pubkey` |
| Initializer | `initializer` | `account` |
| _(not shown)_ | `system_program` | `account` |

### (5465275518454919918) Program Config Set Authority

| Label | Value | Type |
|-------|-------|------|
| Set program config authority | `program_config` | `account` |
| New authority | `new_authority` | `pubkey` |
| Authority | `authority` | `account` |

### (980051451428053093) Program Config Set Multisig Creation Fee

| Label | Value | Type |
|-------|-------|------|
| Set multisig creation fee | `program_config` | `account` |
| New multisig creation fee | `new_multisig_creation_fee` | `lamports` |
| Authority | `authority` | `account` |

### (7755968836925599343) Program Config Set Treasury

| Label | Value | Type |
|-------|-------|------|
| Set program config treasury | `program_config` | `account` |
| New treasury | `new_treasury` | `pubkey` |
| Authority | `authority` | `account` |
